...
の連絡先より作者に報告をお願いいたします。

## ファイル構成 ################################################################

- [D] log        : 最近開いたファイルログ 保存フォルダ (初回起動時に生成)
- [D] presets    : 画像規格ファイル       保存フォルダ (初回起動時に生成)
- [D] properties : 設定ファイル           保存フォルダ (初回起動時に生成)
- [F] tkite.jar  : 実行ファイル

上記の自動生成されるフォルダ類は、アンインストールする時以外に場所を移動したり、
削除したりしないようにしてください。予期せぬ動作の原因になります。

## 実行方法 ####################################################################

"tkite.jar"をダブルクリックしてください。LinuxOSをご使用の方はターミナルか
ら"java -jar tkite.jar"と打ち込んでください。
...
本ソフト配布時のzipに同封のREADME_latest.urlをダブルクリックしてください。本ソフ
トのプログラムを公開しているGithubというサイトにジャンプします。

移動先のサイトに表示されているバージョン情報が、現在ご使用のバージョンよりも上
がっている場合は、移動先サイトの実行ファイルをダウンロードしてご利用ください。

ダウンロード方法がわからなかった場合は、本ソフトをダウンロードしたツクマテコミュ
ニティ・または作者ブログのソフト配布ページのDropboxのリンクから、最新版をダウ
ンロードしてください。

## その他・作者からのお願い ####################################################

- バグの報告は【連絡先】の作者ブログか、ツクマテコミュニティのツール配布のペー
  ジでお願いします。
